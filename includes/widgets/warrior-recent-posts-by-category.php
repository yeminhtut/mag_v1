...
class Warrior_Recent_Post_By_Category extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		/* Added by Alvin @ 21st Mar */ 

 		$client_post_sticky = array();
 		if( in_category('South Korea') ) {
	 		$client_post_sticky = array(32251);
 		}

 		if(count($client_post_sticky)) {
...
?>
		...
		<?php if(count($client_post_sticky)) : ?>
