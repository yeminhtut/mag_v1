<?php 
	$post_tabs_categories_1 = 'South Korea';
	$post_tabs_categories_2 = 'Europe';
	$post_tabs_categories_3 = 'Singapore';
	// $post_tabs_categories_1 = 'destination';
	// $post_tabs_categories_2 = 'interest';
	// $post_tabs_categories_3 = 'Uncategorized';
	$post_tabs_title_limiter = 12;
	$post_tabs_content_limiter = 40;

			$warrior_set_content  = '<h3 style="font-size:35px;margin-bottom:30px;line-height:40px;">Top Destinations</h3>';
			$warrior_set_content  .= '<div id="home_tab" class="homepage-widget widget-type-5 warrior-tabs-widget">';
			$warrior_set_content .= '<ul class="tab-nav">';
        	$warrior_set_content .= '<li><a href="javascript:void(0)" data-content="#tab-'.str_replace(" ","",$post_tabs_categories_1).'" title="" class="active">Korea</a></li>';
			...
			if ( $posts_tab_1->have_posts() ) :
				$warrior_set_content .= '<div id="tab-'.str_replace(" ","",$post_tabs_categories_1).'" class="tab-content row post-wrapper">';
					...
					$get_cat_name = $post_tabs_categories_1;
					...
					$warrior_set_content .= '<div class="column column-2">';
						$warrior_set_content .= '<article class="'.esc_attr( $css_animate_class ).' hentry full-width-post" data-wow-delay="0.3s">';
							...
							$warrior_set_content .= '<div class="entry-content">';
								$warrior_set_content .= '<div class="post-category"><a href="/category/destinations/asia/east-asia/south-korea">Korea</a></div>';
								$warrior_set_content .= '<h3 class="post-title"><a href="'. get_the_permalink() .'">'.wp_trim_words( get_the_title(), absint('40' ), '...' ).'</a></h3>';
				...
				$warrior_set_content .= '<div id="tab-'.str_replace(" ","",$post_tabs_categories_2).'" class="tab-content row post-wrapper">';
					...
					$warrior_set_content .= '<div class="column column-2">';
						$warrior_set_content .= '<article class="'.esc_attr( $css_animate_class ).' hentry full-width-post" data-wow-delay="0.3s">';
							...
							$warrior_set_content .= '</div>';
							$warrior_set_content .= '<div class="entry-content">';
								$warrior_set_content .= '<div class="post-category"><a href="/category/destinations/europe">Europe</a></div>';
				...
				$warrior_set_content .= '<div id="tab-'.str_replace(" ","",$post_tabs_categories_3).'" class="tab-content row post-wrapper">';
					...
					$warrior_set_content .= '<div class="column column-2">';
						$warrior_set_content .= '<article class="'.esc_attr( $css_animate_class ).' hentry full-width-post" data-wow-delay="0.3s">';
							...
							$warrior_set_content .= '</div>';
							$warrior_set_content .= '<div class="entry-content">';
								$warrior_set_content .= '<div class="post-category"><a href="/category/destinations/asia/southeast-asia/singapore">Singapore</a></div>';
								$warrior_set_content .= '<h3 class="post-title"><a href="'. get_the_permalink() .'">'.wp_trim_words( get_the_title(), absint( $post_tabs_title_limiter ), '...' ).'</a></h3>';
								$warrior_set_content .= warrior_post_meta(); // display post meta
								$warrior_set_content .= '<div class="excerpt">';
									$warrior_set_content .= '<p>'.wp_trim_words( get_the_excerpt(), absint( $post_tabs_content_limiter ), '...' ).'</p>';
