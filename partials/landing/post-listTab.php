<?php 
	...
	$warrior_set_content  = '<h3 style="font-size:35px;margin-bottom:30px;line-height:40px;">Make that trip happen</h3>';
	$warrior_set_content  .= '<div id="sports" class="homepage-widget widget-type-5 warrior-tabs-widget wow fadeIn animated">';
			$warrior_set_content .= '<ul class="tab-nav">';
        	$warrior_set_content .= '<li><a href="javascript:void(0)" data-content="#tab-'.str_replace(" ","",$post_tabs_categories_1).'" title="" class="active">Where to stay</a></li>';
			...
			if ( $posts_tab_1->have_posts() ) :
				$warrior_set_content .= '<div id="tab-'.str_replace(" ","",$post_tabs_categories_1).'" class="tab-content row post-wrapper">';
				    ...
				    $warrior_set_content .= '<div class="column column-1"><article class=" hentry full-width-post left-thumbnail" data-wow-delay="0.3s">';
				    ...
				    $warrior_set_content .= '<h3 class="post-title"><a href="'. get_the_permalink() .'">'. get_the_title() .'</a></h3>';
				    $warrior_set_content .='<div class="excerpt"><p>'.wp_trim_words( get_the_excerpt(), absint('40' ), '...' ).'</p>
				    						</div></div></article> </div>';
