<?php 
	$args_posts_list_1 = array(
		'post_type' 			=> 'post',
		'post_status' 			=> 'publish',
		'category__and' 		=> array(3,26),//island id and thailand id
		'ignore_sticky_posts' 	=> 1,
		'posts_per_page' 		=> 4
	);
	$posts_list_1 = new WP_Query();
	$posts_list_1->query( $args_posts_list_1 );
	$interest_post_list_one_content = '<div class="section-title"><h3 class="interest-section-title">Thailand</h3></div>';
	if ( $posts_list_1->have_posts() ) :
		...
		if ( has_post_thumbnail() ) {
			...
			$interest_post_list_one_content .= '<div class="post-category"><a href="/category/destinations/asia/east-asia/south-korea">SOUTH KOREA</a></div>';
