<?php 
	$args_posts_list_1 = array(
		'post_type' 			=> 'post',
		'post_status' 			=> 'publish',
		'category__and' => array(681,108),//shopping id and korea id
		'ignore_sticky_posts' 	=> 1,
		'posts_per_page' 		=> 4
	);
	$posts_list_1 = new WP_Query();
	$posts_list_1->query( $args_posts_list_1 );
	$interest_post_list_one_content = '<div class="section-title"><h3 class="interest-section-title">Korea</h3></div>';
