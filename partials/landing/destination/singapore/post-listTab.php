<?php 
	$post_tabs_categories_1 = 'Travel Inspiration';
	$post_tabs_categories_2 = 'Trip Planning';
	$post_tabs_categories_3 = 'Stays';
	...
	$warrior_set_content .= '<li><a href="javascript:void(0)" data-content="#tab-'.str_replace(" ","",$post_tabs_categories_1).'" title="" class="active">Travel Inspiration</a></li>';
    $warrior_set_content .= '<li><a href="javascript:void(0)" data-content="#tab-'.str_replace(" ","",$post_tabs_categories_2).'" title="">Trip Planning</a></li>';
	$warrior_set_content .= '<li><a href="javascript:void(0)" data-content="#tab-'.str_replace(" ","",$post_tabs_categories_3).'" title="">Stays</a></li>';
    $warrior_set_content .= '</ul>';
	$warrior_set_content  .= '<div class="tabs_container">';
	$args_posts_tab_1 = array(
		'post_type' 			=> 'post',
		'post_status' 			=> 'publish',
		'category__and' => array(135,127),
