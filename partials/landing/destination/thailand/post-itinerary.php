<?php 
	$args = array(
		'post_type' 			=> 'post',
		'post_status' 			=> 'publish',
		'category__and' 		=> array(26),//thailand
		'tag__in' 				=> array(745),//hiking id
		'posts_per_page' 		=> 5
	);
...
<div style="position:relative">
	<div class="section-header">
		<h3 style="font-size:35px;margin-bottom:20px;line-height:56px;border-bottom: solid 2px #ddd;">Itineraries</h3>
	</div>
</div>
