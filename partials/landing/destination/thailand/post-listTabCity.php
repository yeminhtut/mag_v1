<?php 
	$post_tabs_city_1 = 'bangkok';
	$post_tabs_city_2 = 'chiang mai';
	$post_tabs_city_3 = 'krabi';
	$post_tabs_title_limiter = 12;
	$post_tabs_content_limiter = 40;

	$warrior_set_content  = '<div id="landing-city-tab" class="homepage-widget widget-type-5 city-tabs-widget wow fadeIn animated">';
	$warrior_set_content .= '<ul class="tab-nav-city">';
	$warrior_set_content .= '<li><a href="javascript:void(0)" data-content="#tab-'.str_replace(" ","",$post_tabs_city_1).'" title="" class="active">Bangkok</a></li>';
    $warrior_set_content .= '<li><a href="javascript:void(0)" data-content="#tab-'.str_replace(" ","",$post_tabs_city_2).'" title="">Chiang mai</a></li>';
	$warrior_set_content .= '<li><a href="javascript:void(0)" data-content="#tab-'.str_replace(" ","",$post_tabs_city_3).'" title="">Krabi</a></li>';
	...
	$args_posts_tab_1 = array(
			...
			if ( $posts_tab_1->have_posts() ) :
				$warrior_set_content .= '<div id="tab-'.str_replace(" ","",$post_tabs_city_1).'" class="tab-content-city row post-wrapper">';
			...
			if ( $posts_tab_2->have_posts() ) :
				$warrior_set_content .= '<div id="tab-'.str_replace(" ","",$post_tabs_city_2).'" class="tab-content-city row post-wrapper">';
			...
			if ( $posts_tab_3->have_posts() ) :
				$warrior_set_content .= '<div id="tab-'.str_replace(" ","",$post_tabs_city_3).'" class="tab-content-city row post-wrapper">';
