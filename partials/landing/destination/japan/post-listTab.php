<?php 
	$post_tabs_categories_1 = 'shopping and eating';
	$post_tabs_categories_2 = 'culture and heritage';
	...
	$warrior_set_content .= '<li><a href="javascript:void(0)" data-content="#tab-'.str_replace(" ","",$post_tabs_categories_1).'" title="" class="active">Shopping & Eating</a></li>';
    $warrior_set_content .= '<li><a href="javascript:void(0)" data-content="#tab-'.str_replace(" ","",$post_tabs_categories_2).'" title="">Culture & Heritage</a></li>';
