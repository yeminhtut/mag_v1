<?php 
	$post_tabs_categories_1 = 'Greece';
	$post_tabs_categories_2 = 'Italy';
	$post_tabs_categories_3 = 'Switzerland';
	...
	$warrior_set_content .= '<li><a href="javascript:void(0)" data-content="#tab-'.str_replace(" ","",$post_tabs_categories_1).'" title="" class="active">Greece</a></li>';
    $warrior_set_content .= '<li><a href="javascript:void(0)" data-content="#tab-'.str_replace(" ","",$post_tabs_categories_2).'" title="">Italy</a></li>';
	$warrior_set_content .= '<li><a href="javascript:void(0)" data-content="#tab-'.str_replace(" ","",$post_tabs_categories_3).'" title="">Switzerland</a></li>';
    $warrior_set_content .= '</ul>';
	$warrior_set_content .= '<div class="tabs_container">';
	$args_posts_tab_1 = array(
		'post_type' 			=> 'post',
		'post_status' 			=> 'publish',
		'category__and' => array(276),
