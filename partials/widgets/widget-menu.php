<ul id="menu-main_menu" class="main-menu">
	...
	<li id="itinerary" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="/tag/itinerary">ITINERARIES</a></li>
	<?php 
	...
	<li id="giveaways" class="menu-item menu-item-type-custom menu-item-has-children parent-menu" data-id="giveaway"><a href="#">GIVEAWAYS</a>
		
		<ul class="sub-menu" id="giveaway">
			<li><a href="/TripZillaGiveaway">Staycation Giveaway! </a></li>
